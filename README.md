...
Relational Databases is the database software, specifically one which keeps the data organized into a particular kind of table. Postgres, MySQL, Sqlite and so on . SQL is a language used to access and control relational database. You can use SQL to set up databases and modify them, as well as accessing them.

2. Why do tables need a `primary key`?

Tables need a primary key because to uniquiely identify a row on a the table in order to form a relationship with another table.
